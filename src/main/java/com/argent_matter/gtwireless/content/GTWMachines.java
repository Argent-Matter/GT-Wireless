...
public class GTWMachines {
    ...
    static {
        ...
        WIRELESS_ENERGY_HATCH_16A = registerTieredHatches("wireless_energy_input_hatch_16a", (holder, tier) -> new EnergyHatchPartMachine(holder, tier, IO.IN, 16, new Object[0]), (tier, builder) -> {
            String[] voltage = GTValues.VNF;
        ...
        WIRELESS_OUTPUT_HATCH = registerTieredHatches("wireless_energy_output_hatch", (holder, tier) -> new EnergyHatchPartMachine(holder, tier, IO.OUT, 2, new Object[0]), (tier, builder) -> {
            String[] voltage = GTValues.VNF;
        ...
        WIRELESS_OUTPUT_HATCH_4A = registerTieredHatches("wireless_energy_output_hatch_4a", (holder, tier) -> new EnergyHatchPartMachine(holder, tier, IO.OUT, 4, new Object[0]), (tier, builder) -> {
            String[] voltage = GTValues.VNF;
        ...
        WIRELESS_OUTPUT_HATCH_16A = registerTieredHatches("wireless_energy_output_hatch_16a", (holder, tier) -> new EnergyHatchPartMachine(holder, tier, IO.OUT, 16, new Object[0]), (tier, builder) -> {
            String[] voltage = GTValues.VNF;
